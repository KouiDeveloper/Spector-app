...
@Component({
  selector: 'app-a001-header',
  templateUrl: './a001-header.component.html',
  styleUrls: ['./a001-header.component.css'],
  providers: [WebsocketDataServiceService, ChatService, WebsocketService]
})
export class A001HeaderComponent implements OnInit, OnDestroy {
