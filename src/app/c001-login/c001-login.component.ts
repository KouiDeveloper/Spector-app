...
@Component({
  selector: 'app-c001-login',
  templateUrl: './c001-login.component.html',
  styleUrls: ['./c001-login.component.css'],
  providers: [WebsocketDataServiceService, ChatService, WebsocketService]
})
export class C001LoginComponent implements OnInit, OnDestroy {
  ...
  login() {
    ...
    console.log("Username: ", this._loginUser.username);
    console.log("Password: ", this._loginUser.password);
  }
